...
global function OnProjectileCollision_weapon_decoy_audio_grenade
...
void function OnProjectileCollision_weapon_decoy_audio_grenade( entity projectile, vector pos, vector normal, entity hitEnt, int hitbox, bool isCritical )
{
	entity player = projectile.GetOwner()
	if ( hitEnt == player )
		return
